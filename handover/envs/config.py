...
__C.ENV.RELEASE_TIME_THRESH = 0.1
...
__C.ENV.MANO_ROTATION_GAIN_P = 1.0
__C.ENV.MANO_ROTATION_GAIN_D = 0.0
__C.ENV.MANO_JOINT_GAIN_P = 0.1
__C.ENV.MANO_JOINT_GAIN_D = 1.0
__C.ENV.MANO_JOINT_FORCE = 0.5

__C.ENV.COLLISION_ID_TABLE = 2**0
__C.ENV.COLLISION_ID_YCB = lambda i: 2**i
__C.ENV.COLLISION_ID_MANO = 2**22

__C.ENV.RELEASE_FINGER_CONTACT_X_RANGE = (-0.0105, +0.0105)
__C.ENV.RELEASE_FINGER_CONTACT_Y_RANGE = (-0.0025, +0.0025)
__C.ENV.RELEASE_FINGER_CONTACT_Z_RANGE = (+0.0000, +0.0550)
__C.ENV.IS_DRAW_RELEASE = False
__C.ENV.RELEASE_CONTACT_REGION_COLOR = [0.85, 0.19, 0.21, 0.5]
...
__C.BENCHMARK.IS_DRAW_GOAL = False
